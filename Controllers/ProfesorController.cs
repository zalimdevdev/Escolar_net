...
namespace Escolar_net.Controllers
{
    public class ProfesorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Telefono,Direccion")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Email,Telefono,Direccion")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
